    ...
    [          '$stateProvider', '$urlRouterProvider',
      function ($stateProvider,   $urlRouterProvider) {
          ...
          $stateProvider
              ...
              .state('app.log', {
                  url: '/log',
                  templateUrl: 'tpl/log/index.html',
                  resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.select','toaster']).then(
                              function(){
                                 return $ocLazyLoad.load(['js/controllers/log/log.js','js/controllers/modal/log.js','js/controllers/modal/server.js']);
                              }
                          );
                        }
                      ]
              ...
              .state('app.log.list', {
                  url: '/list',
                  templateUrl: 'tpl/log/list/index.html',
